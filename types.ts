...
export type ViewName = 'dashboard' | 'lesson-list' | 'study' | 'writing' | 'reflex' | 'reflex-selector' | 'blitz-game' | 'cram' | 'settings' | 'rule-explorer' | 'kanji-explorer' | 'kanji-network' | 'typing' | 'favorites-manager';
