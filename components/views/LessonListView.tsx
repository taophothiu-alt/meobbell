...
export const LessonListView: React.FC<LessonListProps> = ({ db, onSelect, onUpdateDb, onNotify }) => {
                ...
                <div className="flex justify-between items-center border-b border-white/10 pb-4">
                    ...
                    <div className="flex items-center gap-3">
                        <button 
                            ...
                            className="px-3 py-1 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-lg text-[10px] font-bold uppercase tracking-wider border border-slate-600 transition flex items-center gap-2"
                        >
                            <i className="fas fa-eye-slash"></i> Ẩn/Hiện
                        </button>
